...
1. In the main window of the component, click the **[Edit]** button next to the selection you want to parameterize. The window "Edit Selections" opens, see [Edit Selections](./variants-and-selections#edit-selections).<br> 
