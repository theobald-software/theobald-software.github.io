...
3. Select *Include* in the **Sign** column to only include the filter data to the output. <br>
Select *Exclude* in the **Sign** column to exclude the filter data from the output.
...
Select a runtime parameter from the dropdown list.
