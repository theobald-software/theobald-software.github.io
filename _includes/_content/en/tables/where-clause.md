...
There are 3 options for organizing the criteria of the WHERE clause (1):
...
- **Add Column** adds a column. Click on the component to select a column from the available tables.
