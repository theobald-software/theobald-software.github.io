...
1. Weisen Sie den Xtract Universal/BoardConnector Service einem Windows Service-Account zu. Informationen finden Sie unter [Xtract Universal Service unter einem Windows Service-Account ausführen](./serversicherheit#einen-dienst-unter-einem-windows-dienstkonto-ausführen).
