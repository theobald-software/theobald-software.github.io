...
Dies gilt für die reguläre Extraktion als auch für den [MDX Extraktionsmodus](./eine-bw-cube-quelle-definieren). Das vorangestellte @ kennzeichnet den eingetragenen Wert als benutzerdefinierte Variable. Die Werte für diese Variablen werden dann später beim Auslösen der Extraktion über [URL-Parameter](../fortgeschrittene-techniken/benutzerdefinierte-variablen) übergeben.
