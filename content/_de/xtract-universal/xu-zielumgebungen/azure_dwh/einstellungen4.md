...
Der SQL-Befehl kann bei Bedarf geändert werden, um z.B. bestimmte Spalten von der Aktualisierung auszuschließen.
...
Darüber hinaus können Sie z.B. auch auf der Datenbank bestehende Stored Procedures ausführen.<br>
...
Nur Row Processing wird in einer Transaktion ausgeführt. <br>Prepare und Finalization ohne explizite Transaktion (implizite commits).<br>
