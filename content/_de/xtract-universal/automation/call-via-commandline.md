...
{: .box-note }
**Hinweis:** Beide Versionen unterscheiden sich nicht in ihrer Funktionalität und können als eigenständige Programme auf beliebigen Rechnern kopiert und ausgeführt werden.<br> Achten Sie darauf, dass der Host des Xtract Universal Servers netzwerktechnisch erreichbar ist. 
...
|  -c   | Löscht den Result-Cache (Ergebnis Cache) für die angegebene Extraktion und Optionen.<br> Dies gilt nur für [Pull-Destinationen](./xu-destinationen#pull--und-push-destinationen). | `xu.exe -c` |  
