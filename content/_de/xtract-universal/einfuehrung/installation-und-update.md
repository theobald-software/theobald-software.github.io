...
| XtractCleanup.exe | Anwendung, die alle Ergebnisse im Cache und Log-Dateien entsprechend der [Web Server Einstellungen](../server/server-einstellungen#web-server) von Xtract Universal löscht.|
