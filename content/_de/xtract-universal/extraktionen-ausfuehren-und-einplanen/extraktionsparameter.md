...
hierarchieName | Name der zu extrahierenden Hierarchie für Hierarchie-Extraktorenextractors| verfügbar in ODP & DeltaQ
variant | Name einer Variante | verfügbar in [Report](../report-abap-reports-ansteuern/varianten-und-selektionen) & [SAP Query](../sap-queries/varianten-anwenden)
batchJobName | Name des Batch Jobs| verfügbar in [Report](../report-abap-reports-ansteuern/report-extraktionseinstellungen)
...
logonTicket | ändert dynamisch das Anmeldeticket. Siehe [SSO mit SAP Logon Ticket](../fortgeschrittene-techniken/sap-single-sign-on/sso-with-sap-logon-ticket) für mehr Details.
