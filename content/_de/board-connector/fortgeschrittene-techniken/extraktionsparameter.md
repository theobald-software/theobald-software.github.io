...
gatwewayHost | Gateway Host | verfügbar in [DeltaQ](../datasource-deltaq/customizing-check)
gatewayService | Gateway Service | verfügbar in [DeltaQ](../datasource-deltaq/customizing-check)
programID | Program ID | verfügbar in [DeltaQ](../datasource-deltaq/customizing-check)
logicalDestination | Logische Destination | verfügbar in [DeltaQ](../datasource-deltaq/customizing-check)
