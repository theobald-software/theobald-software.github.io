...
- Plain authentication (Benutzer/Passwort), Secure Network Communications (SNC) mit und ohne Single Sign-On (SSO) and SAP Logon Tickets (MYSAPSSO2) werden unterstützt.
