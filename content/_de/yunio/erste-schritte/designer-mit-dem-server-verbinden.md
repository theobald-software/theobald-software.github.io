...
3. Wenn der Dienst nicht auf dem Standard-Port 8064 läuft (kann in den Servereinstellungen konfiguriert werden), geben Sie den Port an, indem Sie nach dem Hostnamen [:[port]](../server/ports) eintragen.
