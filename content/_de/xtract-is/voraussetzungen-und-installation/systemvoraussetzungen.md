...
- Für die Entwicklung: SQL Server Data Tools werden benötigt, um SSIS-Pakete zu erstellen. Bitte verwenden Sie das entsprechende SSDT für den von Ihnen verwendeten SQL Server. Lesen Sie die [Microsoft Hilfe für Details](https://docs.microsoft.com/en-us/sql/ssdt/download-sql-server-data-tools-ssdt?view=sql-server-ver15)
