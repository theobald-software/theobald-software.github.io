...
Unlike the other components, the Xtract IS for Azure Report component requires the installation of a custom function module in your SAP system before use.
...
Copy the source code from the file Z_XTRACT_REMOTE_REPORT.txt into the text box for the source code using Ctrl+C and Ctrl+V. You can find the file in the Xtract IS for Azure installation directory. Now the function module is ready to use.
