...
<br>
For using this functionality a similar configuration as for [Kerberos Single Sign On against SAP](https://kb.theobald-software.com/sap-connection/sso-with-kerberos-snc) is required.
