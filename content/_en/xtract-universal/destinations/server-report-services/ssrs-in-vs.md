...
2. Right-click on the *Shared Data Sources* folder in the *Solution Explorer* section and select **Add New Data Source**. The window "Shared Data Source Properties" opens.
...
If you set dynamic parameters, you are prompted to enter values for the parameters before the preview is executed.
