...
1. Create a new "Report Server Project" in Visual Studio. <br>If *Reporting Services* is not available, make sure that the [*Microsoft Reporting Services Projects* extension](./requirements#installation) version 2.6.11 or higher is installed and activated.
