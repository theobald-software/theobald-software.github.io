...
This section shows how to call an extraction from a [Windows script (.bat)](../execute-and-automate-extractions/call-via-script#aufruf-via-windows-skript-bat) or [PowerShell script](../execute-and-automate-extractions/call-via-script#aufruf-via-powershell-skript).
