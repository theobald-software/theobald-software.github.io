...
The process for SSO with client certificates is the same as for Xtract Universal, see [Xtract Universal - SSO and SNC with Client Certificates: Process](https://help.theobald-software.com/en/xtract-universal/advanced-techniques/sap-single-sign-on#process).
