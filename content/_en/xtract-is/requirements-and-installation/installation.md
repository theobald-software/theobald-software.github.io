...
{: .box-note }
**Note:** admin user rights are required to install Xtract IS.
...
| xis_version.bat | Version batch file. When starting xis_version.bat, make sure to pass XtractISVersionInfo.exe file as parameter in the directory |
