...
To deal with this problem, it is possible to install a Z-module in the SAP system, see chapter [Installing the Z-function module](../sap-customization/install-report-custom-function-module).
