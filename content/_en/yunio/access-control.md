...
To open the service access control settings, click on the key icon ( ![Login](/img/content/yunio/key.png)) of the service you want to restrict access to. <br>
...
2. Click on the key icon ( ![Login](/img/content/yunio/key.png)) of the service you want to restrict access to. 
...
{: .box-note }
**Note:** When access rights from the server-level and the service level differ, the more restrictive access right applies, e.g., a user with *Read/Execute* privilege on the server level cannot be upgraded to *Modify* on the service level.
