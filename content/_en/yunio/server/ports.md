...
---
The YunIO Server runs as a Windows service with the main process 'C:\Program Files\XtractUniversal\XtractService.exe'. 
...
The configuration server communicates with the YunIO Designer via a dedicated port. <br>
